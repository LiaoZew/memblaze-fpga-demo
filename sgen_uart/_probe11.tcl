...
set clkcell [lindex [get_bd_cells -quiet -filter {VLNV =~ *clk_wiz*}] 0]
create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axi_gpio_0

puts "=== GUI-format automation ==="
catch {apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master {/microblaze_0/M_AXI_DP (Periph)} Clk {/clk_wiz_1/clk_out1 (100MHz)}} [get_bd_intf_pins axi_gpio_0/S_AXI]} r1
puts "r1=[string range $r1 0 120]"
puts "M ports now: [get_bd_intf_pins -quiet ${periph}/M*_AXI]"
puts "PROBE11_DONE"